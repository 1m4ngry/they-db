...
Description-ru: Построить базу данных mandb сейчас?
 У вас пока нет базы данных описаний страниц руководств. Ее создание может
 занять некоторое время, в зависимости от количества установленных страниц
 руководств; создание базы производится в фоновом процессе, что может
...
Description-ru: Вы хотите установить setuid man для man и mandb?
 ...
 отформатированными страницами руководств ('cat pages'), и означает, что
 база данных описаний страниц руководств будет автоматически обновляться
 людьми, просматривающими страницы руководств. Хранение cat страниц
 снижает требования к производительности, что особенно важно для старых
 машин.
...
Description-ru: Перестроить базу данных mandb сейчас?
 ...
 занять некоторое время, в зависимости от количества установленных у вас
 страниц; создание базы производится в фоновом процессе, что может
 замедлить установку остальных пакетов. Вас это устраивает?
 .
 Если вы сейчас не перестроите базу данных, то она будет перестроена при
 запуске /etc/cron.weekly/mandb, или же вы сами можете это сделать, выполнив
 команду 'mandb -c' от пользователя 'man'. Без перестройки базы команды
 'whatis' и 'apropos' не будут действовать правильно.
